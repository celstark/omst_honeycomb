import { ParameterType } from 'jspsych';
    ...
    const info = {
        name: "categorize-multiple-image-keyboard",
        parameters: {
     ...
     *
     * @author Josh de Leeuw and Audrey Hempel
     * @see {@link https://www.jspsych.org/plugins/jspsych-categorize-image/ categorize-image plugin documentation on jspsych.org}
     */
    class CategorizeMultipleImageKeyboardPlugin {
        constructor(jsPsych) {
            this.jsPsych = jsPsych;
        }
        trial(display_element, trial) {
            display_element.innerHTML =
            '<img id="jspsych-categorize-multiple-image-keyboard-stimulus" class="jspsych-categorize-multiple-image-keyboard-stimulus" src="' +
            trial.stimulus +
            '"></img> <img id="jspsych-categorize-multiple-image-keyboard-stimulus2" class="jspsych-categorize-multiple-image-keyboard-stimulus2" src="' +
            trial.stimulus2 +
            '"></img>';
            // hide image after time if the timing parameter is set
            if (trial.stimulus_duration !== null) {
                this.jsPsych.pluginAPI.setTimeout(() => {
                    display_element.querySelector("#jspsych-categorize-multiple-image-keyboard-stimulus").style.visibility = "hidden";
    ...
    CategorizeMultipleImageKeyboardPlugin.info = info;
  
export { CategorizeMultipleImageKeyboardPlugin as jsPsychCategorizeMultipleImageKeyboard };
