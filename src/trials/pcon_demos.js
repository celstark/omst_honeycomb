...
var instr2_stim = function () {
    return "<p>" + lang.pcon.instr2_stim + "</p> <table style = \"width:100%\"> <tr> <td> <img src = \"" + images['pprac1a.jpg'] + "\" height=400 width=400> </td> <td> <img src = \"" + images['pprac1a.jpg'] + "\" height=400 width=400></td></tr></table>";
};
...
var instr3_stim = function () {
    return "<p>" + lang.pcon.instr3_stim + "</p> <table style = \"width:100%\"> <tr> <td> <img src = \"" + images['pprac2a.jpg'] + "\" height=400 width=400> </td> <td> <img src = \"" + images['pprac2b.jpg'] + "\" height=400 width=400> </td> </tr> </table>";
};
...
export { preload, refresh_pcon_trials, instr1_trial, demo1_trial, instr2_trial, demo2_trial, instr3_trial, pcon_end, pconDataCalcFunction };
