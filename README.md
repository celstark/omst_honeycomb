...
- Pairwise perceptual control: Similar to the standard perceptual control task but both images are shown at once. Only compatible with English.
...
- Graphics: Neo for the new graphics including dynamic buttons, a more colorful display, and gamification elements. Classic for a version that looks more like base html.
...
Mad props go to [Audrey Hempel](https://github.com/audrey-hemp/omst_honeycomb), who wrote the first version of the stand-alone task rather than having a relaxing summer break. That was the real heavy lift. After that, [Craig Stark](https://github.com/celstark) created this fork for further development of the project. [Gavin Stark](https://github.com/GavinStark87) was responsible for the most recent updates to the task.
